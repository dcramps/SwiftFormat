...
extension MultiLineAllmanTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__MultiLineAllmanTests = [
        ("testFunc", testFunc),
        ("testGuard", testGuard),
        ("testIf", testIf),
...
extension ParsingHelpersTests {
    ...
    static let __allTests__ParsingHelpersTests = [
        ...
        ("testGenericFuncBracesNotTreatedAsClosure", testGenericFuncBracesNotTreatedAsClosure),
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(MultiLineAllmanTests.__allTests__MultiLineAllmanTests),
